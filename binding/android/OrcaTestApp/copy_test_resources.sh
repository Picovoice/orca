...
cp ../../../resources/.test/android-*_test_data.json ./orca-test-app/src/androidTest/assets/test_resources/
...
cp -r ../../../resources/.test/wav/android-*/ ./orca-test-app/src/androidTest/assets/test_resources/wav/
