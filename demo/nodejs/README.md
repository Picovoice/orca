...
[node-speaker](https://github.com/TooTallNate/node-speaker) is used to play pcm audio generated by Orca to your
device's speakers. On Debian/Ubuntu, `node-speaker` uses the [ALSA](http://www.alsa-project.org/) backend, so you'll
need to install `libasound2-dev` before starting the demo:
