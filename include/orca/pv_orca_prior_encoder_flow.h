#ifndef PV_ORCA_PRIOR_ENCODER_FLOW_H
#define PV_ORCA_PRIOR_ENCODER_FLOW_H
...
typedef struct {
    ...
    const pv_additive_coupling_param_t **flows_param;
} pv_orca_prior_encoder_flow_param_t;
...
typedef struct pv_orca_prior_encoder_flow pv_orca_prior_encoder_flow_t;
...
#endif // PV_ORCA_PRIOR_ENCODER_FLOW_H
