...
macro(add_peer_subdirectory MODULE_NAME)
    if (NOT ${MODULE_NAME}_SUBDIR_ADDED)
        add_subdirectory(${${MODULE_NAME}_SOURCE_DIR} ${${MODULE_NAME}_BINARY_DIR} EXCLUDE_FROM_ALL)
        set(${MODULE_NAME}_SUBDIR_ADDED "TRUE")
    endif ()
endmacro()
