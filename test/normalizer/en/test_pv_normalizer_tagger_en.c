...
static pv_normalizer_use_cases_en_t ALL_TEST_USE_CASES[] = {
...
static const char TAGGER_TEST_SENTENCE[] = "i'm taking vitamin b-12, c, and 15 others!";

static const pv_normalizer_token_tag_en_t TAGGER_TEST_SENTENCE_TAGS[] = {
        PV_NORMALIZER_TAG_EN_WORD,
        PV_NORMALIZER_TAG_EN_WORD,
        PV_NORMALIZER_TAG_EN_WORD,
        PV_NORMALIZER_TAG_EN_WORD,
        PV_NORMALIZER_TAG_EN_CARDINAL,
...
static void test_pv_normalizer_tagger_tokenize_tag_and_check_tags_helper(
        ...
        bool preserve_word_boundary,
        const pv_normalizer_token_tag_en_t *target_tags) {
...
static void test_pv_normalizer_tagger_tag_word(void) {
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_WORD_NORMALIZER};

    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_WORD,
...
static void test_pv_normalizer_tagger_tag_negative_cardinal(void) {
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_NEGATIVE_CARDINAL_NORMALIZER};

    const char sentence[] = "123 -563 −123";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_NONE,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_CARDINAL,
    };
...
static void test_pv_normalizer_tagger_tag_custom_pronunciation(void) {
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_CUSTOM_PRONUNCIATION_NORMALIZER};
...
static void test_pv_normalizer_tagger_tag_invalid_use_case(void) {
    static pv_normalizer_use_cases_en_t invalid_use_cases[] = {99};
...
static void test_pv_normalizer_tagger_tag_number_range(void) {
    const char sentence[] = "12-5 -4-2 hello 43- -9 5-a a-5 6-33 50-50-50 1--3 123–12";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_NUMBER_RANGE_TO,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            ...
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_DIGITS,
            PV_NORMALIZER_TAG_EN_DIGITS_SEPARATOR,
            PV_NORMALIZER_TAG_EN_DIGITS,
            PV_NORMALIZER_TAG_EN_DIGITS_SEPARATOR,
            PV_NORMALIZER_TAG_EN_DIGITS,
            PV_NORMALIZER_TAG_EN_SPACE,
...
static void test_pv_normalizer_tagger_tag_hyphenated_string(void) {
    ...
    const char sentence[] = "4-minute hello -563  some-where 2-2 hello- some–where";
...
static void test_pv_normalizer_tagger_next_char_is_space(void) {
    ...
    const char sentence[] = "4-minute, hello -563  some-where 2-2 hello-";
...
static void test_pv_normalizer_tagger_tag_ordinal(void) {
    static pv_normalizer_use_cases_en_t use_cases[] = {
            PV_NORMALIZER_USE_ORDINAL_NORMALIZER,
            PV_NORMALIZER_USE_CARDINAL_NORMALIZER,
            PV_NORMALIZER_USE_ALPHANUM_SPELL_OUT_NORMALIZER,
            PV_NORMALIZER_USE_WORD_NORMALIZER,
    ...
    const char *sentence =
            "hello 1st 2nd 3rd 6th 10th 11th 12th 13th 21st 52nd 143rd 2000000000000th 10000000000000000000th";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_ORDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_ORDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_ORDINAL,
            ...
            PV_NORMALIZER_TAG_EN_ORDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_CARDINAL_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_CARDINAL_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_CARDINAL_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_CARDINAL_SPELL_OUT,
...
static void test_pv_normalizer_tagger_tag_invalid_ordinal(void) {
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_ORDINAL_NORMALIZER};

    const char *sentences[] = {"1th", "1nd", "1rd", "4st", "11st", "12nd", "13rd", "35st"};
    ...
    for (int32_t i = 0; i < PV_ARRAY_LEN(sentences); i++) {
        ...
        pv_test_true(status == PV_STATUS_SUCCESS, "failed to tag sentence: `%s`", sentence);
        pv_test_true(
                token_list->head->tag != PV_NORMALIZER_TAG_EN_ORDINAL,
...
static void test_pv_normalizer_tagger_tag_negative_ordinal(void) {
    ...
    const char sentence[] =
            "hello -1st -2nd -3rd -6th -10th -11th -12th -13th -21st -52nd -143rd -2000000000000th "
            "-10000000000000000000th −1st";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_NONE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_ORDINAL,
            PV_NORMALIZER_TAG_EN_NEGATIVE_ORDINAL,
            PV_NORMALIZER_TAG_EN_NEGATIVE_ORDINAL,
            PV_NORMALIZER_TAG_EN_NEGATIVE_ORDINAL,
            PV_NORMALIZER_TAG_EN_NEGATIVE_ORDINAL,
...
static void test_pv_normalizer_tagger_tag_invalid_negative_ordinal(void) {
    ...
    for (int32_t i = 0; i < PV_ARRAY_LEN(sentences); i++) {
        ...
        pv_test_true(status == PV_STATUS_SUCCESS, "failed to tag sentence: `%s`", sentence);
        pv_test_true(
                token_list->head->tag != PV_NORMALIZER_TAG_EN_NEGATIVE_ORDINAL,
...
static void test_pv_normalizer_tagger_correct_num_tag_weights(void) {
    pv_test_true(
            PV_ARRAY_LEN(PV_NORMALIZER_TOKEN_TAG_EN_WEIGHTS) == PV_NORMALIZER_TAG_EN_NUM_TAGS,
            "Number of tags and tag weights do not match. Have %d tags and %d weights",
            PV_ARRAY_LEN(PV_NORMALIZER_TOKEN_TAG_EN_WEIGHTS),
            PV_NORMALIZER_TAG_EN_NUM_TAGS);
}

static void test_pv_normalizer_tagger_tag_special_characters(void) {
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_SPECIAL_CHARACTER_NORMALIZER};

    const char sentence[] = "hello 5% A&W @@ °C RPM";
    const char *sentence_strings[] = {"hello", "5", "%", "A", "&", "W", "@", "@", "°C", "RPM"};
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_NONE,
            PV_NORMALIZER_TAG_EN_NONE,
            PV_NORMALIZER_TAG_EN_SPECIAL_CHARACTER,
            PV_NORMALIZER_TAG_EN_NONE,
            PV_NORMALIZER_TAG_EN_SPECIAL_CHARACTER,
            PV_NORMALIZER_TAG_EN_NONE,
            PV_NORMALIZER_TAG_EN_SPECIAL_CHARACTER,
...
static void test_pv_normalizer_tagger_tag_empty_custom_pron(void) {
    ...
    pv_test_true(current != NULL, "token is empty");
    pv_test_true(
            current->tag == PV_NORMALIZER_TAG_EN_CUSTOM_PRONUNCIATION,
            "incorrect tag for `%s`: got `%d`, expected `%d`",
            current->string,
            current->tag,
            PV_NORMALIZER_TAG_EN_CUSTOM_PRONUNCIATION);
...
static void test_pv_normalizer_tagger_tag_weights_order(void) {
    pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_WORD_NORMALIZER};
    ...
    status = pv_normalizer_token_init(0, 4, "{|AY}", false, true, false, &empty_token);
    pv_test_true(status == PV_STATUS_SUCCESS, "failed to initialize token");
    empty_token->tag = PV_NORMALIZER_TAG_EN_WORD;
    ...
    pv_test_true(current != NULL, "token is empty");
    pv_test_true(
            current->tag == PV_NORMALIZER_TAG_EN_WORD,
            "incorrect tag for `%s`: got `%d`, expected `%d`",
            current->string,
            current->tag,
            PV_NORMALIZER_TAG_EN_WORD);
    ...
    pv_normalizer_use_cases_en_t use_cases2[] = {
            PV_NORMALIZER_USE_WORD_NORMALIZER,
            PV_NORMALIZER_USE_CUSTOM_PRONUNCIATION_NORMALIZER};
...
static void test_pv_normalizer_tagger_tag_decimal(void) {
    ...
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_DECIMAL_POINT,
            PV_NORMALIZER_TAG_EN_DECIMAL_DIGITS,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_DECIMAL_POINT,
            PV_NORMALIZER_TAG_EN_DECIMAL_DIGITS,
    ...
    const pv_normalizer_token_tag_en_t sentence_tags2[] = {
            PV_NORMALIZER_TAG_EN_PUNCTUATION,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL};
...
static void test_pv_normalizer_tagger_tag_time(void) {
    const char sentence[] =
            "7:00 p.m. am 09:18 pm 18:23 21:89 25:09 PM p.m. am 8 a.m.. 04:21am 12:00p.m. 2AM 25PM 2a.m. 12p.m. 11:30pm"
            " twelve am ninety am one am to five-thirty am";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_TIME_HOURS,
            PV_NORMALIZER_TAG_EN_TIME_COLON,
            PV_NORMALIZER_TAG_EN_TIME_MINUTES,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_TIME_AM_PM,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_TIME_HOURS,
...
static void test_pv_normalizer_tagger_tag_measurement(void) {
    const char sentence[] = "5 g 1ml -7.3l hello ml 10.1km 5°C 1,000g -1,000,111g 25ft.-lb. clear context ml-g";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_MEASUREMENT,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_MEASUREMENT,
            PV_NORMALIZER_TAG_EN_SPACE,
...
static void test_pv_normalizer_tagger_tag_per_measurement(void) {
    const char sentence[] = "5 km/m 10 oz/km 1.1m/l -5.41kg/ft m/s 7 miles/hour 1,000,000m/s";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_MEASUREMENT,
            PV_NORMALIZER_TAG_EN_PER_SLASH,
            PV_NORMALIZER_TAG_EN_MEASUREMENT,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
...
static void test_pv_normalizer_tagger_tag_comma_cardinal(void) {
    const char *sentence = "1,005 11,005 111,005 -5,123,123,123 1111,000 1,1,000 1, 000 789-with";
...
static void test_pv_normalizer_tagger_tag_comma_ordinal(void) {
    const char *sentence = "1,005th 11,005th 111,005th -5,123,123,123rd 1111,000th 1,1,000th 1, 000th";
...
static void test_pv_normalizer_tagger_tag_comma_number_range(void) {
    const char *sentence = "1,000-2,000 1,000.2-1,000.5 1,123,123-789,789 1,000–2,000";
...
static void test_pv_normalizer_tagger_tag_fraction(void) {
    ...
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_FRACTION_SLASH,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_FRACTION_SLASH,
...
static void test_pv_normalizer_tagger_tag_url(void) {
    ...
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            ...
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_DOT,
            PV_NORMALIZER_TAG_EN_TOP_LEVEL_DOMAIN,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_LETTER_SPELL_OUT,
...
static void test_pv_normalizer_tagger_tag_currency(void) {
    ...
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            ...
            PV_NORMALIZER_TAG_EN_CURRENCY,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_CURRENCY,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_CURRENCY,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_CURRENCY,
            ...
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CURRENCY_SYMBOL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_NEGATIVE_CARDINAL,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CURRENCY_SYMBOL,
...
static void test_pv_normalizer_tagger_tag_abbreviations(void) {
    const char *sentence = "e.g. this i.e. Mr. Ave. St. Dr. Jr. Sr. Gov.";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_ABBREVIATION,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_ABBREVIATION,
...
static void test_pv_normalizer_tagger_tag_digits_sequence(void) {
    ...
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_DIGITS_WITH_PARENTHESES,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_DIGITS,
            PV_NORMALIZER_TAG_EN_DIGITS_SEPARATOR,
            PV_NORMALIZER_TAG_EN_DIGITS,
...
static void test_pv_normalizer_tagger_tag_date(void) {
    ...
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_DATE_MONTH,
            PV_NORMALIZER_TAG_EN_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_EN_DATE_DAY,
            PV_NORMALIZER_TAG_EN_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_EN_DATE_YEAR,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_DATE_DAY,
            PV_NORMALIZER_TAG_EN_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_EN_DATE_MONTH,
    ...
    const char *sentence_two = "June 3, 2020 Sep 8, 1991 03-Jun-2024 32-10-2024 Aug 1";
    const pv_normalizer_token_tag_en_t sentence_tags_two[] = {
            PV_NORMALIZER_TAG_EN_DATE_MONTH,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_DATE_DAY,
            PV_NORMALIZER_TAG_EN_PUNCTUATION,
...
static void test_pv_normalizer_tagger_tag_name(void) {
    const char *sentence = "This is J. R. R. Tolkien John F. Kennedy 8 P.M.";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_NAME_INITIAL_DOT,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_EN_NAME_INITIAL_DOT,
            PV_NORMALIZER_TAG_EN_SPACE,
...
static void test_pv_normalizer_tagger_tag_comma_cardinal_punctuation(void) {
    const char *sentence = "1,000, 1,234: 12,345$.";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_CARDINAL,
            PV_NORMALIZER_TAG_EN_PUNCTUATION,
            PV_NORMALIZER_TAG_EN_CARDINAL,
...
static void test_pv_normalizer_tagger_tag_additional_date(void) {
    const char *sentence = "June 2020, September 1918. March 15th, 2023, October 5th, 2023. 8 May 2023, 31 January 2020. Aug 1";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_DATE_MONTH,
            PV_NORMALIZER_TAG_EN_DATE_YEAR,
            PV_NORMALIZER_TAG_EN_PUNCTUATION,
...
static void test_pv_normalizer_tagger_tag_abbreviation_after_special_char(void) {
    const char *sentence = "(e.g., the 12 liter jug)\nEXT.";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_SPECIAL_CHARACTER,
            PV_NORMALIZER_TAG_EN_ABBREVIATION,
            PV_NORMALIZER_TAG_EN_PUNCTUATION,
...
static void test_pv_normalizer_tagger_tag_domain_extensions_only(void) {
...
static void test_pv_normalizer_tagger_tag_temperature_punctuation(void) {
    const char *sentence = "about 10-15°C. (or 22°C). 12°F";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
...
static void test_pv_normalizer_tagger_tag_cardinal_in_parentheses(void) {
    const char *sentence = "feet (8,848 meters). (1,101) (1,123$)";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPECIAL_CHARACTER,
            PV_NORMALIZER_TAG_EN_CARDINAL,
...
static void test_pv_normalizer_tagger_tag_single_quote(void) {
    const char *sentence = "time to ask, 'Where you at.' '(hello)' '1,000dm' '1,000$' 'Mr. Abc' 'and etc.' '-1st'";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_WORD,
...
static void test_pv_normalizer_tagger_length_future_past_context(void) {
    const char *sentence = "within 3-5 days. #AB12 www.example.com 9:30 1/2 1/1,000 1,123rd 2ml 2m/h -1,900,876";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_WORD,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CARDINAL,
...
static void test_pv_normalizer_tagger_length_future_past_context_collapse(void) {
    const char *sentence = "$1,250.50 5,000.25$ Mr. 7:00 p.m. 04:21am 12:00p.m. 7a.m. Dr.A.B e.g.";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
            PV_NORMALIZER_TAG_EN_CURRENCY,
            PV_NORMALIZER_TAG_EN_SPACE,
            PV_NORMALIZER_TAG_EN_CURRENCY,
...
static void test_pv_normalizer_tagger_length_future_past_context_single_quote(void) {
    const char *sentence = "dog's leash and Chris' shoes.";
    const pv_normalizer_token_tag_en_t sentence_tags[] = {
        PV_NORMALIZER_TAG_EN_WORD,
        PV_NORMALIZER_TAG_EN_SPACE,
        PV_NORMALIZER_TAG_EN_WORD,
...
static void test_pv_normalizer_tagger_tag_cardinal_helper_failure(void) {
    ...
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_CARDINAL_NORMALIZER};
    pv_normalizer_tagger_t *tagger = NULL;
    pv_normalizer_token_list_t *token_list = NULL;
...
static void test_pv_normalizer_tagger_tag_currency_helper_failure(void) {
    ...
    static pv_normalizer_use_cases_en_t use_cases[] = {PV_NORMALIZER_USE_CURRENCY_NORMALIZER};
    pv_normalizer_tagger_t *tagger = NULL;
    pv_normalizer_token_list_t *token_list = NULL;
...
static const pv_test_case_t PV_NORMALIZER_TAGGER_TEST_CASES[] = {
        ...
        {"tag_comma_ordinal", test_pv_normalizer_tagger_tag_comma_ordinal},
        ...
        {"tag_comma_fraction", test_pv_normalizer_tagger_tag_fraction},
        ...
        {"tag_comma_cardinal_punctuation", test_pv_normalizer_tagger_tag_comma_cardinal_punctuation},
        {"tag_additional_date", test_pv_normalizer_tagger_tag_additional_date},
        {"tag_abbreviation_after_special_char", test_pv_normalizer_tagger_tag_abbreviation_after_special_char},
        {"tag_domain_extensions_only", test_pv_normalizer_tagger_tag_domain_extensions_only},
        {"tag_temperature_punctuation", test_pv_normalizer_tagger_tag_temperature_punctuation},
        ...
        {"length_future_past_collapse", test_pv_normalizer_tagger_length_future_past_context_collapse},
...
const pv_test_suite_t PV_NORMALIZER_TAGGER_EN_TEST_SUITE = {
        .name = "normalizer_tagger_en",
