...
static const char TAGGER_TEST_SENTENCE[] = "私はビタミンB-12、C、その他15種類を摂取しています。";

static const pv_normalizer_token_tag_ja_t TAGGER_TEST_SENTENCE_TAGS[] = {
        PV_NORMALIZER_TAG_JA_WORD,
        PV_NORMALIZER_TAG_JA_WORD,
        PV_NORMALIZER_TAG_JA_WORD,
        PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
        PV_NORMALIZER_TAG_JA_CARDINAL,
...
static void test_pv_normalizer_tagger_tokenize_tag_and_check_tags_helper(
        ...
        bool preserve_word_boundary,
        const pv_normalizer_token_tag_ja_t *target_tags) {
...
static void test_pv_normalizer_tagger_tag_word(void) {
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_WORD_NORMALIZER_JA};

    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_WORD,
...
static void test_pv_normalizer_tagger_tag_punctuation(void) {
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_PUNCTUATION_NORMALIZER_JA};
...
static void test_pv_normalizer_tagger_tag_cardinal(void) {
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_CARDINAL_NORMALIZER_JA};
...
static void test_pv_normalizer_tagger_tag_negative_cardinal(void) {
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_NEGATIVE_CARDINAL_NORMALIZER_JA};

    const char sentence[] = "123 -563";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_NONE,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_NEGATIVE_CARDINAL};
...
static void test_pv_normalizer_tagger_tag_custom_pronunciation(void) {
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_CUSTOM_PRONUNCIATION_NORMALIZER_JA};
...
static void test_pv_normalizer_tagger_tag_invalid_use_case(void) {
    static pv_normalizer_use_cases_ja_t invalid_use_cases[] = {99};
...
static void test_pv_normalizer_tagger_tag_number_range(void) {
    const char sentence[] = "12-5 -4-2 こんにちは 43- -9 5-a a-5 6-33 50-50-50 1--3";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_NUMBER_RANGE_TO,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            ...
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_DIGITS,
            PV_NORMALIZER_TAG_JA_DIGITS_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DIGITS,
            PV_NORMALIZER_TAG_JA_DIGITS_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DIGITS,
            PV_NORMALIZER_TAG_JA_SPACE,
...
static void test_pv_normalizer_tagger_correct_num_tag_weights(void) {
    pv_test_true(
            PV_ARRAY_LEN(PV_NORMALIZER_TOKEN_TAG_JA_WEIGHTS) == PV_NORMALIZER_TAG_JA_NUM_TAGS,
            "Number of tags and tag weights do not match. Have %d tags and %d weights",
            PV_ARRAY_LEN(PV_NORMALIZER_TOKEN_TAG_JA_WEIGHTS),
            PV_NORMALIZER_TAG_JA_NUM_TAGS);
}

static void test_pv_normalizer_tagger_tag_special_characters(void) {
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_SPECIAL_CHARACTER_NORMALIZER_JA};

    const char sentence[] = "こんにちは 5% A&W @@ °C RPM";
    const char *sentence_strings[] = {"こんにちは", "5", "%", "A", "&", "W", "@", "@", "°C", "RPM"};
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_NONE,
            PV_NORMALIZER_TAG_JA_SPECIAL_CHARACTER,
            PV_NORMALIZER_TAG_JA_NONE,
            PV_NORMALIZER_TAG_JA_SPECIAL_CHARACTER,
            PV_NORMALIZER_TAG_JA_NONE,
            PV_NORMALIZER_TAG_JA_SPECIAL_CHARACTER,
...
static void test_pv_normalizer_tagger_tag_empty_custom_pron(void) {
    ...
    status = pv_normalizer_token_init(0, 4, "{|n o}", false, true, false, &empty_token);
    ...
    pv_test_true(current != NULL, "token is empty");
    pv_test_true(
            current->tag == PV_NORMALIZER_TAG_JA_CUSTOM_PRONUNCIATION,
            "incorrect tag for `%s`: got `%d`, expected `%d`",
            current->string,
            current->tag,
            PV_NORMALIZER_TAG_JA_CUSTOM_PRONUNCIATION);
...
static void test_pv_normalizer_tagger_tag_weights_order(void) {
    ...
    status = pv_normalizer_token_init(0, 4, "{|n o}", false, true, false, &empty_token);
    pv_test_true(status == PV_STATUS_SUCCESS, "failed to initialize token");
    empty_token->tag = PV_NORMALIZER_TAG_JA_WORD;
    ...
    pv_test_true(current != NULL, "token is empty");
    pv_test_true(
            current->tag == PV_NORMALIZER_TAG_JA_WORD,
            "incorrect tag for `%s`: got `%d`, expected `%d`",
            current->string,
            current->tag,
            PV_NORMALIZER_TAG_JA_WORD);
    ...
    pv_normalizer_use_cases_ja_t use_cases2[] = {
            PV_NORMALIZER_USE_WORD_NORMALIZER_JA,
            PV_NORMALIZER_USE_CUSTOM_PRONUNCIATION_NORMALIZER_JA};
...
static void test_pv_normalizer_tagger_tag_decimal(void) {
    ...
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_DECIMAL_POINT,
            PV_NORMALIZER_TAG_JA_DECIMAL_DIGITS,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_DECIMAL_POINT,
            PV_NORMALIZER_TAG_JA_DECIMAL_DIGITS,
    ...
    const pv_normalizer_token_tag_ja_t sentence_tags2[] = {
            PV_NORMALIZER_TAG_JA_PUNCTUATION,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CARDINAL};
...
static void test_pv_normalizer_tagger_tag_time(void) {
    const char sentence[] = "7:00 p.m. こんにちは 09:18:13 18:23 21:89 25:09 p.m. am 8 a.m.. "
                            "04:21am 12:00p.m. 2AM 25PM 2a.m. 12p.m. 8時15分";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_TIME_HOURS,
            PV_NORMALIZER_TAG_JA_TIME_COLON,
            PV_NORMALIZER_TAG_JA_TIME_MINUTES,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_TIME_AM_PM,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_TIME_HOURS,
            ...
            PV_NORMALIZER_TAG_JA_TIME_MINUTES,
            PV_NORMALIZER_TAG_JA_TIME_COLON,
            PV_NORMALIZER_TAG_JA_TIME_SECONDS,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_TIME_HOURS,
            PV_NORMALIZER_TAG_JA_TIME_COLON,
            PV_NORMALIZER_TAG_JA_TIME_MINUTES,
...
static void test_pv_normalizer_tagger_tag_measurement(void) {
    const char sentence[] = "5 g 1ml -7.3l こんにちは ml 10.1km 5°C 1,000g -1,000,111g 25ft.-lb. コンテキスト ml-g";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_MEASUREMENT,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_MEASUREMENT,
            PV_NORMALIZER_TAG_JA_SPACE,
...
static void test_pv_normalizer_tagger_tag_per_measurement(void) {
    const char sentence[] = "5 km/m 10 oz/km 1.1m/l -5.41kg/ft m/s 7 miles/hour 1,000,111m/s";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_MEASUREMENT,
            PV_NORMALIZER_TAG_JA_PER_SLASH,
            PV_NORMALIZER_TAG_JA_MEASUREMENT,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
...
static void test_pv_normalizer_tagger_tag_fraction(void) {
    const char *sentence = "1/2 1/3.2 1/1,000 1,000/1,000 1/-4 -4/1";

    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_FRACTION_SLASH,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_FRACTION_SLASH,
...
static void test_pv_normalizer_tagger_tag_url(void) {
    const char *sentence = "www.hi.com https://hi.xyz/";
    ...
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            ...
            PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_JA_DOT,
            PV_NORMALIZER_TAG_JA_TOP_LEVEL_DOMAIN,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
...
static void test_pv_normalizer_tagger_tag_currency(void) {
    ...
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            ...
            PV_NORMALIZER_TAG_JA_CURRENCY,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_NEGATIVE_CURRENCY,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_NEGATIVE_CURRENCY,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_NEGATIVE_CURRENCY,
            ...
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CURRENCY_SYMBOL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_NEGATIVE_CARDINAL,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_CURRENCY_SYMBOL,
...
static void test_pv_normalizer_tagger_tag_abbreviations(void) {
    const char *sentence = "e.g. こんにちは i.e. Mr. Ave. St. Dr. Jr. Sr. Gov.";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_ABBREVIATION,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_ABBREVIATION,
...
static void test_pv_normalizer_tagger_tag_digits_sequence(void) {
    ...
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_DIGITS_WITH_PARENTHESES,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_DIGITS,
            PV_NORMALIZER_TAG_JA_DIGITS_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DIGITS,
...
static void test_pv_normalizer_tagger_tag_date(void) {
    ...
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_DATE_MONTH,
            PV_NORMALIZER_TAG_JA_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DATE_DAY,
            PV_NORMALIZER_TAG_JA_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DATE_YEAR,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_DATE_DAY,
            PV_NORMALIZER_TAG_JA_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DATE_MONTH,
    ...
    const char *sentence_two = "2020年6月3日 6月3日2024年 20日2024年10月 8月1日 2024年";
    const pv_normalizer_token_tag_ja_t sentence_tags_two[] = {
            PV_NORMALIZER_TAG_JA_DATE_YEAR,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_DATE_YEAR,
            PV_NORMALIZER_TAG_JA_SPACE,
...
static void test_pv_normalizer_tagger_tag_name(void) {
    const char *sentence = "こちらは J. R. R. トールキン、ジョン F. ケネディ、午後 8 時です。";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_WORD,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_JA_NAME_INITIAL_DOT,
            PV_NORMALIZER_TAG_JA_SPACE,
            PV_NORMALIZER_TAG_JA_LETTER_SPELL_OUT,
            PV_NORMALIZER_TAG_JA_NAME_INITIAL_DOT,
            PV_NORMALIZER_TAG_JA_SPACE,
...
static void test_pv_normalizer_tagger_length_future_past_context_after_tag(void) {
    const char *sentence = "3-5 時。 @AB12 www.ex.com 9:30 1/2 1/1,000 2ml 2m/h -1,900,876";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_CARDINAL,
            PV_NORMALIZER_TAG_JA_NUMBER_RANGE_TO,
            PV_NORMALIZER_TAG_JA_CARDINAL,
...
static void test_pv_normalizer_tagger_length_future_past_context_after_tag_date_digits(void) {
    const char *sentence = "2023/12/25 1829-06-03 (778) 239-1823 102-291-4920 123.456.789";
    const pv_normalizer_token_tag_ja_t sentence_tags[] = {
            PV_NORMALIZER_TAG_JA_DATE_YEAR,
            PV_NORMALIZER_TAG_JA_DATE_SEPARATOR,
            PV_NORMALIZER_TAG_JA_DATE_MONTH,
...
static void test_pv_normalizer_tagger_tag_currency_helper_failure(void) {
    ...
    const char sentence[] = "5$";
    static pv_normalizer_use_cases_ja_t use_cases[] = {PV_NORMALIZER_USE_CURRENCY_NORMALIZER_JA};
    pv_normalizer_tagger_t *tagger = NULL;
    pv_normalizer_token_list_t *token_list = NULL;
...
static const pv_test_case_t PV_NORMALIZER_TAGGER_JA_TEST_CASES[] = {
...
const pv_test_suite_t PV_NORMALIZER_TAGGER_JA_TEST_SUITE = {
        .name = "normalizer_tagger_ja",
        .setup = test_pv_normalizer_tagger_setup,
        .teardown = test_pv_normalizer_tagger_teardown,
        .num_test_cases = PV_ARRAY_LEN(PV_NORMALIZER_TAGGER_JA_TEST_CASES),
        .test_cases = PV_NORMALIZER_TAGGER_JA_TEST_CASES,
};
