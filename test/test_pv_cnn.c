...
static const float TEST_TOLERANCE_PERCENT_K1 = 0.0001f;
static const float TEST_TOLERANCE_PERCENT_K3 = 0.0001f;
static const float TEST_TOLERANCE_PERCENT_K5 = 0.0001f;
static const float TEST_TOLERANCE_PERCENT_K7 = 0.0001f;
static const float TEST_TOLERANCE_PERCENT_DEPTHWISE = 0.0001f;
static const float TEST_TOLERANCE_PERCENT_TRANSPOSED_DEPTHWISE = 0.0001f;

#else

static const float TEST_TOLERANCE_PERCENT_K1 = 0.01f;
static const float TEST_TOLERANCE_PERCENT_K3 = 0.01f;
static const float TEST_TOLERANCE_PERCENT_K5 = 0.015f;
static const float TEST_TOLERANCE_PERCENT_K7 = 0.01f;
static const float TEST_TOLERANCE_PERCENT_DEPTHWISE = 0.015f;
static const float TEST_TOLERANCE_PERCENT_TRANSPOSED_DEPTHWISE = 0.01f;

#endif

static const float TEST_EPSILON_K1 = 0.005f;
static const float TEST_EPSILON_K3 = 0.0065f;
static const float TEST_EPSILON_K5 = 0.005f;
static const float TEST_EPSILON_K7 = 0.0065f;
static const float TEST_EPSILON_DEPTHWISE = 0.005f;
static const float TEST_EPSILON_TRANSPOSED_DEPTHWISE = 0.005f;
...
static void test_pv_cnn_depthwise_forward(void) {
    ...
    pv_test_close_float_array(
            ...
            TEST_TOLERANCE_PERCENT_DEPTHWISE,
            TEST_EPSILON_DEPTHWISE,
...
static void test_pv_cnn_transposed_depthwise_forward(void) {
    ...
    pv_test_close_float_array(
            ...
            TEST_TOLERANCE_PERCENT_TRANSPOSED_DEPTHWISE,
            TEST_EPSILON_TRANSPOSED_DEPTHWISE,
