...
static pv_status_t test_pv_orca_multilingual_setup(void) {
...
static void test_pv_orca_multilingual_teardown(void) {
    pv_ypu_delete(ypu);
}
...
const pv_test_suite_t PV_ORCA_MULTILINGUAL_TEST_SUITE = {
        ...
        .setup = test_pv_orca_multilingual_setup,
        .teardown = test_pv_orca_multilingual_teardown,
